      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8 sm:py-12">
        <div className="w-full max-w-lg animate-fade-in-up">
          ...
          <div className="text-center mb-6">
            <h1 className="text-xl sm:text-2xl font-extrabold text-foreground tracking-tight mb-2">Dispositivo Não Autorizado</h1>
          ...
          <div className="rounded-xl sm:rounded-2xl border border-destructive/20 bg-card shadow-sm overflow-hidden mb-4">
            <div className="bg-destructive/8 border-b border-destructive/15 px-4 sm:px-5 py-3">
              <h2 className="text-xs sm:text-sm font-bold text-destructive flex items-center gap-2">
                <AlertTriangle className="h-3.5 w-3.5 shrink-0" />Acesso Bloqueado por Segurança
              </h2>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
            ...
            <div className="rounded-xl border border-border bg-card p-3 sm:p-4">
              ...
              <p className="text-[10px] sm:text-xs text-muted-foreground leading-relaxed">
                Entre em contato com o suporte pelo 121 (Disque Social) de segunda a sexta, das 8h às 20h.
              </p>
            </div>
          </div>
