        ...
        <div className="w-full max-w-lg animate-fade-in-up">
          <div className="text-center mb-4 sm:mb-6">
            ...
            <p className="text-[10px] sm:text-xs text-muted-foreground mt-1">
              Seus benefícios serão liberados em até 48 horas úteis
            </p>
          </div>
          ...
          <div className="rounded-xl border border-border bg-card shadow-sm overflow-hidden">
            ...
            <div className="px-3.5 sm:px-5 pb-3.5 sm:pb-4">
              <div className="rounded-lg bg-muted/30 border border-border p-2 sm:p-2.5 flex items-center justify-center gap-3 sm:gap-4 text-[8px] sm:text-[9px] text-muted-foreground flex-wrap">
                ...
                <span>•</span>
                <div className="flex items-center gap-1"><Shield className="h-2.5 w-2.5 text-accent" /><span>Comprovante válido</span></div>
              </div>
            </div>
          </div>

          <button onClick={onBack} className="mt-3.5 sm:mt-4 w-full rounded-xl py-3 sm:py-3.5 text-xs sm:text-sm font-bold gradient-primary text-primary-foreground hover:opacity-90 transition-all shadow-md active:scale-[0.98] flex items-center justify-center gap-2">
            <ArrowLeft className="h-3.5 w-3.5 sm:h-4 sm:w-4" />Nova Consulta
          </button>
        </div>
      </div>
